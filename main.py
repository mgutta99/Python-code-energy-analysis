...
"""
#pip install cbsodata pandas matplotlib
...
keyword = df_tables[df_tables['Title'].str.contains("renewable energy", case=False)]  ### motivation
...
filtered_data = filtered_data[filtered_data['Periods'] >= '2010']  #since 1st offshore windfarm commissioned in 2006!
